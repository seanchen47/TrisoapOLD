...
if($EMAIL != null){
        if($CUSIDT == 'A'){
                ...
                while($row = mysql_fetch_array($result)){
                    ...
                    echo "訂單種類:".$row['ORDTYPE']." 顧客編號:".$row['CUSNO']." 缺貨狀態:".$row['BACKSTAT']." 訂單狀態:".$row['ORDSTAT']." 額外指令:".$row['ORD_INST']." 訂單總額:".$row['TOTALPRICE']." 訂單總值:".$row['TOTALAMT']." 建立日期:".$row['CREATEDATE']."</br>";
  				}
  				echo "<br>";
?>
