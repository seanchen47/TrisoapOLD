    ...
    <div id="wrapper">
        ...
        <section id="about-slider">
                ...
                if($ORDNO != null){
                    ...
                    if($row[0] == '1'){
                        ...
                        if($message != null){
                        	...
                        	$sql = "SELECT * FROM ITEMMAS where ITEMNO='1'";
                        	$result = mysql_query($sql);
                        	$row = mysql_fetch_row($result);
                            ...
                            echo "商品價格：$row[3] <br>";
                            echo "訂購數量：";
                            echo "<font color=\"black\"> <input type=\"text\" name=\"ITEMAMT\" min=\"1\" max=\"50\"/> </font> <br>";
            ...
            <div style="float: left; margin-left: 70px">
                <br><br><br>
                <img src="../Homepages/images/test/soap1.jpg" alt="" height=265 width=450>
            </div>
