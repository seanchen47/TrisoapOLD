...
// AJAX function to store ORDNO into session by sessionORDNO.php
$(".ordnos").click(function() {
	// 不知為何會抓到很多空白...轉成String之後trim去空白
	var thisORDNO = $(this).text().toString().trim();
	$.ajax({
		type: "POST",
		url: "sessionORDNO.php",
		data: {ORDNO: thisORDNO}
	});
});